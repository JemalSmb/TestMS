...
function NavBar(){
    ...
    return (
            <div className="navbar bg-transparent">
                ...
                <a href="/" className='text-black font-Oxanium text-2xl font-bold px-10 space-x-4 pt-2'>Explore</a>
                <a href="/" className='text-black font-Oxanium text-2xl font-bold px-10 space-x-4 pt-2'>Live</a>
                <a href="/" className='text-black font-Oxanium text-2xl font-bold px-10 space-x-4 pt-2'>Dashboard</a>
