...
function NavBar(){
    ...
    return (
            <div className="navbar bg-transparent">
                ...
                <span><a className='text-white font-Oxanium text-2xl font-bold px-10 pt-2'/>Explore</span>
                <div className='space-x-4 lg:flex items-center connect-button-container'>
                    <a href={Connect.Path}>
