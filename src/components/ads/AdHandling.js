    ...
    return (
        <div>
         <div className="text-center pt-6">
          ...
          <div className="ads-container flex-grow justify-center gap-4 flex-wrap m-auto flex flex-col overflow-y-auto" style={{ gridTemplateColumns: `repeat(auto-fill, minmax(250px, 1fr))` }}>
